...
activities = {
    ...
    "Soccer Club": {
        "description": "Develop skills and play matches with other schools",
    ...
    "Drama Club": {
        "description": "Rehearse scenes, practice stagecraft, and perform plays",
    ...
    "Debate Team": {
        ...
        "max_participants": 14,
        "participants": ["grace@mergington.edu", "liam.k@mergington.edu"]
    }
}
